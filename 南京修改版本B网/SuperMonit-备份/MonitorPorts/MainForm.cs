...
namespace MonitorPorts
{
    public partial class MainForm : Form
    {
        ...
        List<string> VOBCToGround = new List<string>();
        List<string> GroundToVOBC = new List<string>();
        ...
        private void LoadHistory()
        {
            ...
            if (BackUps.Count != 0)
            {
                try
                {
                    ...
                    FilterOptionForm.MaxVOBCToGround = Convert.ToDouble(BackUps[4]) / 1000;
                    FilterOptionForm.MaxGroundToVOBC = Convert.ToDouble(BackUps[5]) / 1000;
        ...
        private void Show(PacketProperties Properties)
        {
            ...
            {
                case SendDir.VOBCToGround:
                    UpdateChart(FilterOptionForm.MaxVOBCToGround, Properties.Name, this.listViewVOBCToGround, this.chartVOBCToGroundLine, this.chartVOBCtoGroundPie, VOBCToGround, Properties);
                    break;
                case SendDir.GroundToVOBC:
                    UpdateChart(FilterOptionForm.MaxVOBCToGround, Properties.Name, this.listViewGroundToVOBC, this.chartGroundToVOBCLine, this.chartGroundToVOBCPie, GroundToVOBC, Properties);
                    break;
                default:
                    break;
            }
        ...
        private void Clear()
        {
            ...
            listViewVOBCToGround.Items.Clear();
            listViewGroundToVOBC.Items.Clear();
            Chart[] charts = { chartVOBCToGroundLine, chartVOBCtoGroundPie,chartGroundToVOBCLine, chartGroundToVOBCPie};
            ClearChart(charts);
        }
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            else
            {
                ...
                if (thReceive != null && thReceive.IsAlive)
                {
                    thReceive.Abort();
                }
