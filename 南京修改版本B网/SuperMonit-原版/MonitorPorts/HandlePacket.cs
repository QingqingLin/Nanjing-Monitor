...
namespace MonitorPorts
{
    class HandlePacket
    {
        ...
        {
            if (SourceDevice.Type == "车载" && DestDevice.Type == "地面")
            {
                Properties.SendDir = SendDir.VOBCToGround;
                Properties.Name = SourceDevice.Name + "--" + DestDevice.Name;
                return true;
            }
            else if (SourceDevice.Type == "地面" && DestDevice.Type == "车载")
            {
                Properties.SendDir = SendDir.GroundToVOBC;
                Properties.Name = SourceDevice.Name + "--" + DestDevice.Name;
                return true;
            }
            else
